...
const Signup = () => {
    const { signInWithGithub, signInWithGoogle } = useFirebase()
    return (
        <div>
            <center>
                ...
                <div className="w-full max-w-xs">
                    <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                        ...
                        <div className="mb-4">
                            ...
                            <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="number" type="text" placeholder="+8801700000000" />
                        </div>
                        <div className="mb-6">
                            <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="email">
                                Enter your email
                            </label>
                            <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="email" type="email" placeholder="yourname@example.com" />
                        </div>
                        <div className="mb-6">
                        ...
                        <div className='mt-3'>
                            ...
                            <center>
                                ...
                                <button onClick={signInWithGithub} className='text-black font-bold py-2 px-4 mt-2 border rounded flex justify-between align-center'><img className='login-logo mr-2' src="https://cdn-icons-png.flaticon.com/512/25/25231.png" alt="" /><span className='login-social-margin'>Login With GitHub</span></button>
                            </center>
